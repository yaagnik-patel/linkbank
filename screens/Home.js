    ...
    <View className="flex-1" style={{ backgroundColor: "#F3E8FF" }}>
      ...
      <View className="flex-1 relative overflow-hidden">
        <Animated.View style={{ transform: [{ translateY: bgFloat }] }}>
          <View
            className="absolute top-16 right-10 w-16 h-16 rounded-full opacity-80"
            style={{ backgroundColor: "#FDE047" }}
          />
          <View
            className="absolute top-24 -left-10 w-40 h-40 rounded-full opacity-40"
            style={{ backgroundColor: "#F472B6" }}
          />
          <View
            className="absolute top-40 -right-10 w-48 h-48 rounded-full opacity-30"
